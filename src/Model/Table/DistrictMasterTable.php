 ...
 *
 * @property \App\Model\Table\StateMasterTable|\Cake\ORM\Association\BelongsTo $StateMaster
 *
 ...
 */
class DistrictMasterTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['state_id'], 'StateMaster'));

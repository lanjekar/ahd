 ...
 * @var \App\Model\Entity\DiseaseMaster[]|\Cake\Collection\CollectionInterface $diseaseMaster
 */
?>
...
<div class="diseaseMaster index large-9 medium-8 columns content">
    <h3><?= __('Disease Master') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($diseaseMaster as $diseaseMaster): ?>
            <tr>
                <td><?= $this->Number->format($diseaseMaster->disease_id) ?></td>
                <td><?= h($diseaseMaster->disease_name) ?></td>
                <td><?= $this->Number->format($diseaseMaster->is_active) ?></td>

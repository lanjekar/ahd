...
<div class="sampleApplicableTest view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Test Result') ?></th>
            <td><?= h($sampleApplicableTest->test_result) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Communication Result') ?></th>
        ...
        <tr>
            <th scope="row"><?= __('Test Suggestion') ?></th>
        ...
        <tr>
            <th scope="row"><?= __('Observation Result') ?></th>

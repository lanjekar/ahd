 ...
 *
 */
class StateMasterFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'state_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created_on' => '2018-03-08 11:29:32',
            'created_by' => 1,
            'modified_on' => '2018-03-08 11:29:32',
            'modified_by' => 1
        ],
    ];
}

 ...
 * @var \App\Model\Entity\StateMaster[]|\Cake\Collection\CollectionInterface $stateMaster
 */
?>
...
<div class="stateMaster index large-9 medium-8 columns content">
    <h3><?= __('State Master') ?></h3>

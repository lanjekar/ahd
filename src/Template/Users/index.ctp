    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('taluka') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $user->has('lab_master') ? $this->Html->link($user->lab_master->lab_id, ['controller' => 'LabMaster', 'action' => 'view', $user->lab_master->lab_id]) : '' ?></td>
                <td><?= h($user->first_name) ?></td>
                <td><?= h($user->last_name) ?></td>
                <td><?= h($user->email) ?></td>
                <td><?= h($user->mobile) ?></td>
                <td><?= h($user->user_role) ?></td>
                <td><?= h($user->village) ?></td>
                <td><?= h($user->taluka) ?></td>
                <td><?= h($user->state) ?></td>

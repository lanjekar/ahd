 ...
 * @var \App\Model\Entity\DispatchMaster[]|\Cake\Collection\CollectionInterface $dispatchMaster
 */
?>
...
<div class="dispatchMaster index large-9 medium-8 columns content">
    <h3><?= __('Dispatch Master') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($dispatchMaster as $dispatchMaster): ?>
            <tr>
                <td><?= $this->Number->format($dispatchMaster->dispatch_id) ?></td>
                <td><?= h($dispatchMaster->dispatch_type) ?></td>
                <td><?= $this->Number->format($dispatchMaster->is_active) ?></td>

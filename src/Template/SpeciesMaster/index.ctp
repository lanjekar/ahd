 ...
 * @var \App\Model\Entity\SpeciesMaster[]|\Cake\Collection\CollectionInterface $speciesMaster
 */
?>
...
<div class="speciesMaster index large-9 medium-8 columns content">
    <h3><?= __('Species Master') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($speciesMaster as $speciesMaster): ?>
            <tr>
                <td><?= $this->Number->format($speciesMaster->species_id) ?></td>
                <td><?= h($speciesMaster->species_name) ?></td>
                <td><?= $this->Number->format($speciesMaster->is_active) ?></td>
